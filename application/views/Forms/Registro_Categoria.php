  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>index.php/Admin"><i class="fa fa-dashboard"></i> Panel de Control</a></li>
        <li><a href="<?php echo base_url();?>index.php/Categoria">Categorias</a></li>
        <li class="active"></li>
      </ol>
    </section>
